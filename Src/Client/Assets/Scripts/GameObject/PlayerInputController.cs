...
public class PlayerInputController : MonoBehaviour {
    ...
    private void LateUpdate()
    {
        ...
        if ((GameObjectTool.WorldToLogic(this.rb.transform.position) - this.character.position).magnitude > 20)
        {
    ...
    void SendEntityEvent(EntityEvent entityEvent)
    {
        if (entityController != null)
        {
            ...
            Services.MapService.Instance.SendEntitySync(entityEvent,character.EntityData);
        }
    }
}
